...
################################################################################
###############################################################################
#     @GuildWars2.gw2Group.command(name="apitest", hidden=True)
...
################################################################################
################################################################################
#     @GuildWars2.gw2Group.command(hidden=True)
...
################################################################################
############################################################################### 
#     @GuildWars2.gw2Group.command(name="ping", hidden=True)
#     @commands.cooldown(1, gw2Utils.get_settings("Gw2Cooldowns", "MiscCooldown"), BucketType.user)
...
#             ip = gw2Utils.get_settings("WORLDS_IP", world_name.upper())
