"""create_profanity_filters

Revision ID: 7
Revises: 6
Create Date: 2023-11-12 17:50:18.468431
...
def upgrade() -> None:
    ...
    op.create_unique_constraint('profanity_filters_id_key', 'profanity_filters', ['id'])
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute('DROP TRIGGER IF EXISTS before_update_profanity_filters_tr ON bot_configs')
    op.drop_index(op.f('ix_profanity_filters_server_id'), table_name='profanity_filters')
    op.drop_constraint('profanity_filters_id_key', 'profanity_filters', type_='unique')
