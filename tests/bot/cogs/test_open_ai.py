...
class TestOpenAi:
    ...
    async def test_ai_command_success(self, mock_send_embed, mock_get_settings, 
                                    openai_cog, mock_ctx, mock_bot_settings, mock_openai_response):
    ...
    @patch('src.bot.cogs.open_ai.get_bot_settings')
    @patch('src.bot.cogs.open_ai.bot_utils.send_embed')
    async def test_ai_command_error(self, mock_send_embed, mock_get_settings, 
                                  openai_cog, mock_ctx, mock_bot_settings):
    ...
    @pytest.mark.asyncio
    @patch('src.bot.cogs.open_ai.get_bot_settings')
    async def test_get_ai_response_success(self, mock_get_settings, openai_cog, 
                                         mock_bot_settings, mock_openai_response):
    ...
    @pytest.mark.asyncio
    @patch('src.bot.cogs.open_ai.get_bot_settings')
    async def test_get_ai_response_with_leading_trailing_spaces(self, mock_get_settings, openai_cog, 
                                                              mock_bot_settings, mock_openai_response):
    ...
    @patch('src.bot.cogs.open_ai.get_bot_settings')
    @patch('src.bot.cogs.open_ai.bot_utils.send_embed')
    async def test_ai_command_with_different_models(self, mock_send_embed, mock_get_settings, 
                                                   openai_cog, mock_ctx, mock_openai_response):
    ...
    @patch('src.bot.cogs.open_ai.get_bot_settings')
    @patch('src.bot.cogs.open_ai.bot_utils.send_embed')
    async def test_ai_command_with_long_question(self, mock_send_embed, mock_get_settings, 
                                               openai_cog, mock_ctx, mock_bot_settings):
    ...
    @patch('src.bot.cogs.open_ai.get_bot_settings')
    @patch('src.bot.cogs.open_ai.bot_utils.send_embed')
    async def test_ai_command_with_special_characters(self, mock_send_embed, mock_get_settings, 
                                                    openai_cog, mock_ctx, mock_bot_settings):
    ...
    @pytest.mark.asyncio
    @patch('src.bot.cogs.open_ai.get_bot_settings')
    async def test_get_ai_response_system_message_content(self, mock_get_settings, openai_cog, 
                                                        mock_bot_settings, mock_openai_response):
    ...
    @pytest.mark.asyncio
    @patch('src.bot.cogs.open_ai.get_bot_settings')
    async def test_get_ai_response_api_parameters(self, mock_get_settings, openai_cog, 
                                                mock_bot_settings, mock_openai_response):
    ...
    @patch('src.bot.cogs.open_ai.get_bot_settings')
    @patch('src.bot.cogs.open_ai.bot_utils.send_embed')
    async def test_ai_command_error_logging(self, mock_send_embed, mock_get_settings, 
                                          openai_cog, mock_ctx, mock_bot_settings):
    ...
    @patch('src.bot.cogs.open_ai.get_bot_settings')
    @patch('src.bot.cogs.open_ai.bot_utils.send_embed')
    async def test_ai_command_send_embed_parameters(self, mock_send_embed, mock_get_settings, 
                                                   openai_cog, mock_ctx, mock_bot_settings):
    ...
    @pytest.mark.asyncio
    @patch('src.bot.cogs.open_ai.get_bot_settings')
    async def test_get_ai_response_empty_response(self, mock_get_settings, openai_cog, 
                                                mock_bot_settings):
