...
def mock_command_data():
    ...
    return [
        {"name": "hello", "created_by": 67890, "created_at": datetime.now(), "description": "Hello command"},
        {"name": "rules", "created_by": 11111, "created_at": datetime.now(), "description": "Rules command"},
    ]
