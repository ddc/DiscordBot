...
class TestInfoCommand:
        ...
        with patch('src.gw2.cogs.wvw.Gw2KeyDal') as mock_dal:
            ...
            with patch('src.gw2.cogs.wvw.Gw2Client') as mock_client:
                ...
                mock_client_instance.call_api = AsyncMock(
                    side_effect=APIKeyError(mock_ctx.bot, "Invalid key")
                )
    ...
    @pytest.mark.asyncio
    async def test_info_world_given_calls_get_world_id(self, mock_bot, mock_ctx, sample_matches_data, sample_worldinfo_data):
